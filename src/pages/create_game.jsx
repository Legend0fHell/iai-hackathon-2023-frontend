...
const CreateGame = () => {
    ...
    const allow = name != '' && diff != '' && desc != '' && tframe != '' && file != '' && testid != '' && progress == 100
    console.log(allow)
                                ...
                                <Box sx={{
                                    ...
                                    <Box>
                                        ...
                                        <Box sx={{
                                            ...
                                            <Image src={image1} width={400} height={400} alt='image' style={{
                                                objectFit: 'cover',
                                                borderRadius: '16px',
                                                width: '100%',
                                                height: 'auto',
                            ...
                            <Grid xs={7} >
                                ...
                                <Box sx={{
                                            ...
                                            <Grid xs={4} sx={{
                                                ...
                                                <Image src={image1} width={400} height={400}
                                                    style={{
                                                        ...
                                                        aspectRatio: '16/10',
                                                        borderRadius: '12px',
                                                        boxShadow: '0px 0px 0px 0px rgba(0, 0, 0, 0.10), 0px 2px 5px 0px rgba(0, 0, 0, 0.10), 0px 9px 9px 0px rgba(0, 0, 0, 0.09), 0px 21px 12px 0px rgba(0, 0, 0, 0.05), 0px 37px 15px 0px rgba(0, 0, 0, 0.01), 0px 57px 16px 0px rgba(0, 0, 0, 0.00)',
                                                    }} />
                                    ...
                                    <Typography variant='body2' sx={{
                                        ...
                                        The default mode is quiz to quiz. Choose other mode in this section
                                    </Typography>

                                    <FormControl sx={{ width: '30ch', paddingBottom: '16px' }} required>
                                        <InputLabel id="demo-simple-select-label">Convert Mode</InputLabel>
                                        <Select
                                            id="nums_of_member"
                                            value={c_mode}
                                            label="Members"
                                    ...
                                    <Typography variant='body2' sx={{
                                        ...
                                        Please provide question file so that we can convert it to game
                                    </Typography>
                                    ...
                                    <Box sx={{
                                        ...
                                        <FormControl sx={{ width: '30ch', marginBottom: '16px' }} variant="outlined">
                                            <InputLabel htmlFor="outlined-adornment-file" sx={{
                                                maxWidth: 'calc(100% - 50px)'
                                            }}>{file[0] ? file[0].name : ''}</InputLabel>
                                            <OutlinedInput
