...
const CreateGame = () => {
  ...
  const handleSubmit = async () => {
    const res = await fetch(
      `http://157.245.149.209:8000/data/${testid}/questions`
    );
        ...
        if (value) {
          const id = setInterval(async () => {
            ...
            const res = await axios.get(
              `http://157.245.149.209:8000/data/${value.testid}/progress`
            );
              ...
              <Grid xs={7}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MenuItem value={"Trò chơi vương quyền"}>
                        Trò chơi vương quyền
                      </MenuItem>
                      <MenuItem value={"Trò chơi giải tích I"}>
                        Trò chơi giải tích I
                      </MenuItem>
                      <MenuItem value={"Hard"}>Hard</MenuItem>
                    </Select>
                  </FormControl>
