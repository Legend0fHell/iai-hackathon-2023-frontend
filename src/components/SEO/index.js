...
SEO.defaultProps = {
    ...
    schemaType: "Article",
    title: 'Testeria',
    description: 'Testeria là một sản phẩm nhắm tới mục đích tự động hóa việc chuyển những file câu hỏi nhàm chán thành những game RPG đầy sự thú vị và hứng thú. Thử Testeria ngay hôm nay.',
